...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [OS_WIN_LAYOUT] = LAYOUT_moonlander(
    ...
    TD(DNC_ESC_LS), KC_1,           KC_2,           KC_3,          KC_4,           KC_5,                KC_6,                           KC_BSPC,    KC_7,        KC_8,                      KC_9,        KC_0,    KC_TRANSPARENT, KC_TRANSPARENT,
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, TD(DNC_RTN_L0), TT(NAV_LAYOUT), LT(FKEYS_LAYOUT, KC_TAB),           TD(DNC_BACKSPACE),              TT(NUMKEYS_LAYOUT),      LT(FKEYS_LAYOUT, KC_SCLN), KC_LBRC,     KC_RBRC, KC_TRANSPARENT, KC_LGUI,
  ...
  [NAV_LAYOUT] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT,     KC_PGUP,        KC_HOME,        KC_ENTER,       KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                 KC_TRANSPARENT, KC_TRANSPARENT,         KC_HOME,        KC_PGUP,        KC_PGDN,        KC_END,         KC_NO,
    KC_TRANSPARENT,     KC_PGDN,        KC_END,         KC_UP,          C(KC_C),        KC_TRANSPARENT, KC_TRANSPARENT,                 KC_TRANSPARENT, KC_TRANSPARENT,         TD(DNC_LEFT),   KC_UP,          KC_DOWN,        TD(DNC_RIGHT),  KC_NO,
    ...
    KC_TRANSPARENT,     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                   KC_TRANSPARENT, KC_TRANSPARENT, KC_NUM_LOCK,     KC_KP_SLASH,    KC_KP_ASTERISK, KC_TRANSPARENT, KC_TRANSPARENT,
