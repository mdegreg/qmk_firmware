...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [NUMKEYS_LAYOUT] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT,     KC_PGDN,        KC_END,         KC_UP,          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                   KC_TRANSPARENT, KC_TRANSPARENT, KC_KP_4,         KC_KP_5,        KC_KP_6,        KC_KP_PLUS,     KC_TRANSPARENT,
